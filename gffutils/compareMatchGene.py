...
ws2["A1"] = (
    "Gene located on forward strand in this genome, but on reverse or absent in the other"
)
ws2["A1"].fill = notice_forward
ws2["A2"] = (
    "Gene located on reverse strand in this genome, but on forward or absent in the other"
)
